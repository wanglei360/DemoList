package www.yj.com.myapplication.dialog;
...
import www.yj.com.myapplication.R;
...
public class ProgressWheel extends View {
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.MaterialProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.MaterialProgressWheel_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MaterialProgressWheel_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MaterialProgressWheel_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MaterialProgressWheel_matProg_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.MaterialProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.MaterialProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MaterialProgressWheel_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.MaterialProgressWheel_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.MaterialProgressWheel_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.MaterialProgressWheel_matProg_progressIndeterminate, false)) {
            spin();
        }
