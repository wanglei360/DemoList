package com.yoland.adatepicker.ios.wheelview;

import java.util.LinkedList;
import java.util.List;

import com.yoland.adatepicker.R;
import com.yoland.adatepicker.ios.ResourcesCompat;
...
public class WheelView extends View {
	...
	public void setWheelForeground(int resource) {
		...
		centerDrawable = ResourcesCompat.getDrawable(getContext(), wheelForeground);
	}
